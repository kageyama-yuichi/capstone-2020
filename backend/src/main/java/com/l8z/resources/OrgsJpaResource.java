...
public class OrgsJpaResource {
	...
	public List<Orgs> retrieve_orgs(@PathVariable String username) {
		...
		try {
			...
			for (int i = 0; i < temp_sql.size(); i++) {
				...
				// For This, the Role of the Member Does Not Matter As Comparison is between
				// username
	...
	@GetMapping("jpa/orgs/{username}/sql")
	public List<OrgsSQL> retrieve_orgs_sql(@PathVariable String username) {
		System.out.println("System - Retrieving Orgs");
		List<OrgsSQL> users_orgs = new ArrayList<OrgsSQL>();
	...
	public ResponseEntity<Void> update_org(@PathVariable String username, @PathVariable String org_id,
	...
	public ResponseEntity<Void> invite_to_org(@PathVariable String inviter, @PathVariable String org_id,
	...
	public ResponseEntity<Void> invite_to_channel_org(@PathVariable String inviter, @PathVariable String org_id,
			@PathVariable String channel_title, @PathVariable String invitee) {
		String unique = org_id + "." + invitee;
		...
		/*
		 * // Create the Simple Mail Message and Set the Email, Subject and Message
		 * SimpleMailMessage msg = new SimpleMailMessage(); User user =
		 * userjpa.findByUsername(invitee); // Set the Email msg.setTo(user.getEmail());
		 * // Set the Subject msg.setSubject("L8Z - New Organisation Channel Invite");
		 * // Set the Body Content msg.setText(
		 * "Hello "+user.getFname()+" "+user.getLname()+",\n\n" +
		 * "Your L8Z account has received a new organisation channel invite! You currently have "
		 * + pendingjpa.findByInvitee(invitee).size()+ " pending invites.\n\n" +
		 * "Thank you for choosing L8Z,\n L8Z Team." );
		 * 
		 * // Send the Email mail.send(msg);
		 */
		return ResponseEntity.noContent().build();
	}

	@GetMapping("jpa/user/invite/orgs/{unique_id}/{user_has_accepted}")
	public ResponseEntity<Void> user_decision_on_invite(@PathVariable String unique_id,
	...
	public ResponseEntity<Void> remove_invited_user_from_org(@PathVariable String remover,
	...
	public ResponseEntity<Void> manage_users_in_org(@PathVariable String org_id, @RequestBody List<Members> body) {
	...
	public ResponseEntity<Void> remove_user_from_org(@PathVariable String org_id, @RequestBody Members old_member) {
	...
	public ResponseEntity<Void> create_channel(@PathVariable String username, @PathVariable String org_id,
	...
	public Channels retrieve_channel(@PathVariable String username, @PathVariable String org_id,
	...
	public ResponseEntity<Void> update_channel(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title, @RequestBody Channels channel) {
	...
	public ResponseEntity<Void> delete_channel(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title) {
	...
	public ResponseEntity<Void> add_users_to_channel(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title, @RequestBody List<Members> added_members) {
		OrgsSQL sql = null;
		Orgs temp_org = null;
	...
	public ResponseEntity<Void> remove_users_from_channel(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title, @RequestBody List<Members> removed_members_from_channel) {
		OrgsSQL sql = null;
		Orgs temp_org = null;
	...
	public boolean validate_channel_title(@PathVariable String org_id, @PathVariable String old_channel_title,
			@PathVariable String new_channel_title) {
		OrgsSQL sql = null;
		Orgs temp_org = null;
	...
	public List<OrgTodo> retrieve_org_todos(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title) {
	...
	public OrgTodo retrieve_org_todo(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title, @PathVariable long id) {
		return orgstodojpa.findById(id).get();
	}

	@PostMapping("/jpa/orgs/todos/{username}/{org_id}/{channel_title}/new")
	public ResponseEntity<Void> create_org_todo(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title, @RequestBody OrgTodo todo) {
	...
	public ResponseEntity<Void> update_org_todo(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title, @PathVariable long id, @RequestBody OrgTodo todo) {
	...
	public ResponseEntity<Void> update_org_todo_status(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title, @PathVariable long id) {
		OrgTodo todoToUpdate = orgstodojpa.getOne(id);
	...
	public ResponseEntity<Void> delete_org_todo(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title, @PathVariable long id) {
	...
	public List<String> retrieve_all_instance_titles(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title) {
	...
	public ResponseEntity<Void> create_instance(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title, @RequestBody Instances instance) {
	...
	public ResponseEntity<Void> update_instance(@PathVariable String username, @PathVariable String org_id,
			@PathVariable String channel_title, @PathVariable String instance_title, @RequestBody Instances instance) {
	...
	public ResponseEntity<Void> delete_instance(@PathVariable String username, @PathVariable String org_id,
