...
class AddUserToChannelComponent extends Component {
	...
	add_users_to_channel = () => {
		...
		console.log(new_users_to_channels);
	...
	componentDidMount() {
		console.log("Org ID: ",this.props.org_id);
		console.log("Channel Title: ",this.props.channel_title);
		console.log("Org Members: ",this.props.members);
		console.log("Channel Members: ",this.props.current_members_in_channel);
		console.log("Org Members Details: ",this.props.org_member_details);
